$(document).ready(function(){
  ...
  $('.venues-description').slick({
    ...
    beforeChange: function (event, slick, currentSlide, nextSlide) {
        $('.venues-logos').removeClass(slick.$slides.eq(currentSlide).data('class') + '-current').addClass(slick.$slides.eq(nextSlide).data('class') + '-current')
    }
});

  $('.slick-dots button').empty();

  if ($('.venues-description').on('afterChange'))

  $('.logo-1').click(function () {
    $('#slick-slide00').click();
    $('.venues-logos img').removeClass('is--active');
  ...
  $('.logo-4').click(function () {
    $('#slick-slide03').click();
    $('.venues-logos img').removeClass('is--active');
    $(this).addClass('is--active');
  });

  $('.logo-5').click(function () {
    $('#slick-slide04').click();
    $('.venues-logos img').removeClass('is--active');
    $(this).addClass('is--active');
  });

  $('.logo-6').click(function () {
    $('#slick-slide05').click();
    $('.venues-logos img').removeClass('is--active');
    $(this).addClass('is--active');
  });
  ...
  // Scroll Stuff
    ...
    .setClassToggle('.about', 'in--view')
    .addTo(controller);

    var scene2 = new ScrollMagic.Scene({ 
      triggerElement: '.venues',
      triggerHook: 'onMiddle',
      reverse: false
    })
    .setClassToggle('.venues', 'in--view')
    .addTo(controller);
    ...
    .setClassToggle('.services', 'in--view')
    .addTo(controller);
...
var configProfile = {
  "profile": {"screenName": 'andrewcorb'},
  "domId": 'feed-container',
  "maxTweets": 3,
  "enableLinks": true, 
  "showUser": true,
  "showTime": true,
